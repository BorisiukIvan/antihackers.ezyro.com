...
.brook {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/br.png");
}
.bking {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/bk.png");
}
.bknight {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/bn.png");
}
.bpawn {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/bp.png");
}
.bqueen {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/bq.png");
}
.bbishop {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/bb.png");
}
.wking {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/wk.png");
}
.wqueen {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/wq.png");
}
.wrook {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/wr.png");
}
.wbishop {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/wb.png");
}
.wknight {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/wn.png");
}
.wpawn {
   background-image: url("https://www.c4355.com/chess-themes/pieces/neo/150/wp.png");
}
.piece {
    background-size: 100%;
    cursor: grab;
...
function checkMove(move) {
    ...
    if (solution[x_puzzle_len].length == 5) {
        ...
        guess = prompt('В какую фигуру вы хотите превратить пешку?').toUpperCase();
        if (p != guess) {
            raiseError('Неверный ход');
            return 0;
        };
//        console.log(s2.className, s1.className, s1.className.split('piece ')[1], piece_arr[p])
    ...
    if (x_puzzle_len >= solution.length) {
        ...
        raiseSuccess('Вы решили задачу!');
        return 1;
    } else raiseSuccess('Это правильный ход, продолжайте!');
...
function makeMove(sq) {
   if (!buffer) {
       ...
       if (document.getElementById('sq_' + sq).className == 'chess-square') {
           raiseErr('Ходы можно делать только фигурами');
           return;
       };
       buffer = sq;
...
function loadNextPuzzle() {
    resetBoard();
    if (arr.length == 0) {
        alert("Поздравляю! Вы решили все доступные задачи! Возвращайтесь завтра за новыми!");
        return;
    }
    console.log(arr);
...
<p style='font-size: 18px'>Задача №<b id='number'></b></p>
<div style='height: 100px'></div>
<button id='next_puzzle' onclick='loadNextPuzzle()'>Загрузить новую задачу</button>
<div style='height: 100px'></div>
<div id='hint'>
<br>
<p style='font-size: 20px'>Цель: <b id='goal'></b></span>
