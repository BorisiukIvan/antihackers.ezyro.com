...
<p id='p'>Server: <b id='srv'>play.chessbase.com</b></p>
<button onclick='changeServer()' style='width: 50%; height: 40px; background-color: blue; color: white; text-align: center'>Change server (4 server avaible)</button>
</center>
